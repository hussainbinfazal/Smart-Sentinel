...
function DropdownMenuContent({
  ...
  sideOffset = 4,
  ...props
}: DropdownMenuPrimitive.DropdownMenuContentProps & { sideOffset: number }) {
  return (
...
function DropdownMenuItem({
  ...
  variant = "default",
  ...props
}: DropdownMenuPrimitive.DropdownMenuItemProps & { variant: "default" | "destructive" } & { inset?: boolean }) {
  return (
...
function DropdownMenuCheckboxItem({
  ...
  checked,
  ...props
}: DropdownMenuPrimitive.DropdownMenuCheckboxItemProps & { checked: boolean }) {
  return (
